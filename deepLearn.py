...
def train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, device, num_epochs=25, patience=5):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            epochs_without_improvement = 0
            # Save the best model
            torch.save(model.state_dict(), 'resnet18_ecgML3.pth')
            print('Model saved to resnet18_ecgML3.pth')
        else:
...
def main():
    ...
    # Path to the dataset
    dataPath = '/Users/justinhuang/Documents/Developer/ML/ecgML3/ecgData'
